            ...
            return (
              <div key={type} className="mb-32 last:mb-0">
                <div className="flex items-center gap-6 mb-16">
                  <h3 className="text-4xl font-serif font-black text-school-navy capitalize">{type} {type === 'Faculty' && '- PGT'}</h3>
                    ...
                    <table className="w-full text-left border-collapse bg-white">
                      <thead>
                        <tr className="bg-school-navy text-white text-[10px] font-black uppercase tracking-[0.2em]">
                          ...
                          <th className="p-8 border-b border-white/10 uppercase">{type === 'Faculty' ? 'Designation' : 'Role'}</th>
